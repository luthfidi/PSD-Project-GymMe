            ...
            <div class="max-w-2xl mx-auto bg-white shadow-xl rounded-xl overflow-hidden">
                <div class="px-8 py-6">
                    ...
                    <div class="mt-8 flex items-center justify-between">
                        <asp:Button ID="BtnUpdate" runat="server" Text="Update Supplement" CssClass="flex-grow mr-2 justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition" OnClick="BtnUpdate_Click" />
                        <asp:Button ID="BtnCancel" runat="server" Text="Cancel" CssClass="flex-grow ml-2 justify-center py-3 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition" OnClick="BtnCancel_Click" />
                    </div>
                </div>
            </div>
        </div>
